...
public ArrayList<ProductInfoDTO> selectByKeyWord(String keyword){
	...
	String sql="SELECT *  FROM product_info WHERE product_name LIKE '%"+keyword+"%' OR product_name_kana LIKE '%"+keyword+"%'";
...
public ArrayList<ProductInfoDTO> selectByKeyWords(String[] keywords){
	...
	for(int k=0;k<keywords.length;k++){
		sql=sql+" WHERE product_name LIKE '%"+keywords[k]+"%' OR product_name_kana LIKE '%"+keywords[k]+"%' ";
	}
	try{
		PreparedStatement ps=con.prepareStatement(sql);
