...
<tbody>
<tr>
<th><h3>新規購入情報入力</h3></th>
</tr>

	<s:form action="CheckDestinationInfoAction">
		...
		<td>電話番号:<s:textfield  name="telNumber" value="%{telNumber}" /></td>
		<td>住所:<s:textfield  name="userAddress" value="%{userAddress}" /></td>
		<td><br></td>
